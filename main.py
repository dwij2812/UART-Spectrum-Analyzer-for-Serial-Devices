...
def clicked():
    ...
    mplcursors.cursor(ax[2,0],hover=True)
    mplcursors.cursor(ax[2,1],hover=True)
    mplcursors.cursor(ax[3,0],hover=True)
    mplcursors.cursor(ax[3,1],hover=True)
    mplcursors.cursor(ax[3,2],hover=True)
...
def clicked_with_limited():
    ...
    cursor10 = Cursor(ax[3, 0], useblit=True, color='red', linewidth=2)
    ...
    mplcursors.cursor(line2,multiple=True).connect("add", lambda sel: sel.annotation.draggable(True))
    mplcursors.cursor(line3,multiple=True).connect("add", lambda sel: sel.annotation.draggable(True))
    mplcursors.cursor(line4,multiple=True).connect("add", lambda sel: sel.annotation.draggable(True))
    mplcursors.cursor(line5,multiple=True).connect("add", lambda sel: sel.annotation.draggable(True))
    mplcursors.cursor(ax[1,0],multiple=True).connect("add", lambda sel: sel.annotation.draggable(True))
    mplcursors.cursor(ax[1,1],multiple=True).connect("add", lambda sel: sel.annotation.draggable(True))
    mplcursors.cursor(ax[2,0],multiple=True).connect("add", lambda sel: sel.annotation.draggable(True))
    mplcursors.cursor(ax[2,1],multiple=True).connect("add", lambda sel: sel.annotation.draggable(True))
    mplcursors.cursor(ax[3,0],multiple=True).connect("add", lambda sel: sel.annotation.draggable(True))
    mplcursors.cursor(ax[3,1],multiple=True).connect("add", lambda sel: sel.annotation.draggable(True))
    mplcursors.cursor(ax[3,2],multiple=True).connect("add", lambda sel: sel.annotation.draggable(True))
    plt.show()
